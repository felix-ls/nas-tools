...
[![GitHub stars](https://img.shields.io/github/stars/felix-ls/nas-tools?style=plastic)](https://github.com/felix-ls/nas-tools/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/felix-ls/nas-tools?style=plastic)](https://github.com/felix-ls/nas-tools/network/members)
[![GitHub issues](https://img.shields.io/github/issues/felix-ls/nas-tools?style=plastic)](https://github.com/felix-ls/nas-tools/issues)
[![GitHub license](https://img.shields.io/github/license/felix-ls/nas-tools?style=plastic)](https://github.com/felix-ls/nas-tools/blob/master/LICENSE.md)
[![Docker pulls](https://img.shields.io/docker/pulls/enticeu/nas-tools?style=plastic)](https://hub.docker.com/r/enticeu/nas-tools)
[![Platform](https://img.shields.io/badge/platform-amd64/arm64-pink?style=plastic)](https://hub.docker.com/r/enticeu/nas-tools)


Docker：https://hub.docker.com/repository/docker/enticeu/nas-tools

TG频道：https://t.me/nastool

WIKI：https://github.com/felix-ls/nas-tools/wiki
...
### 1、Docker
```
docker pull enticeu/nas-tools:latest
```
...
```
git clone -b master https://github.com/felix-ls/nas-tools --recurse-submodule 
...
https://github.com/felix-ls/nas-tools/releases
